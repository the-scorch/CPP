...
constexpr T3 euler = T3(2.71828); // Template variable

template <typename T4, int min>
int arrMax(T4 arr[], int n)
{ // non-type argument
    int m = min;
    for (int i = 0; i < n; i++)
    {
...
template <int N>
struct Factorial // Template Metaprogramming
{
