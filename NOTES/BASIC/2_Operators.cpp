...
int main()
{
     ...
     int a = 10; ++a; // +1 Before using the value
     int b = 10; b++; // +1 After using the value
     int c = 10; --c; // -1 Before using the value
     int d = 10; d--; // -1 After using the value

     cout << sum << "\t" << sub << "\t" << mul << "\t" << div << "\t" << mod << "\n"
          << a << "\t" << b << "\t" << c << "\t" << d << "\n\n";

     // Assignment
     int c1, c2, c3, c4, c5; c1 = c2 = c3 = c4 = c5 = 10;
     c1 += 7; // c1 = c1 + 7
     c2 -= 4; // c2 = c2 - 4
     c3 *= 2; // c3 = c3 * 2
     c4 /= 2; // c4 = c4 / 2
